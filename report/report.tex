...
\author{
  \textbf{Li Langye, Zhang Yingyun, Wu Ruihang, Chen Shaokai} \\
...
To strictly adhere to global final assignment submission integrity standards, the team evaluation formally outlines the individual contributions across all project phases. The overall contribution distribution is as follows: \textbf{Li Langye (30\%)}, \textbf{Zhang Yingyun (30\%)}, \textbf{Wu Ruihang (20\%)}, and \textbf{Chen Shaokai (20\%)}.

\subsection*{Project Implementation and Architecture (30\%)}
\begin{itemize}
\item \textbf{Li Langye (ID: 225040134):} Led the core project implementation and architecture design. Specifically formulated the progressive unfreezing constraints, wrote the PyTorch dynamic asynchronous data-loader operations for On-the-fly Data Augmentation, conducted model training, and evaluated the DET curve tradeoffs and EER intersection points across all ablation domains.
\end{itemize}

\subsection*{Presentation and Visual Design (30\%)}
\begin{itemize}
\item \textbf{Zhang Yingyun (ID: 225040127):} Took charge of the project presentation. Designed the PPT slides, constructed the visual layouts for effectively communicating the mathematical boundary requirements and real-world VoLTE constraints, and structured the oral presentation flow.
\end{itemize}

\subsection*{Literature Review and Analysis (20\%)}
\begin{itemize}
\item \textbf{Wu Ruihang (ID: 225040272):} Conducted comprehensive academic literature research on the limitations of modern ADD-C benchmark findings. Orchestrated the synthesis of related work and assisted in logging validation experiment states and tracking model inference behaviors.
\end{itemize}

\subsection*{Data Processing and Report Drafting (20\%)}
\begin{itemize}
\item \textbf{Chen Shaokai (ID: 225040280):} Handled data processing and matrix configurations for the dataset. Configured the deep LaTeX architectural styling environments, drafted the introductory technical limitations, and formatted the final academic report ensuring precise reference bibliography linking.
\end{itemize}
